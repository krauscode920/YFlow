...
class Adam:
    ...
    # In yflow/optimizers/adam.py, modify the update method:

    def update(self, params: Dict[str, Union[np.ndarray, 'cp.ndarray']],
        ...
        for param_name in params:
            ...
            # For parameters that don't exist yet or have shape mismatch
            if param_name not in self.m or self.m[param_name].shape != param.shape:
